        ...
        {showConfirmation && (
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-1000 p-4 modal-overlay">
            <div className="bg-white dark:bg-secondary-950 rounded-3xl p-8 max-w-md w-full text-center shadow-2xl animate-slide-in border border-secondary-200 dark:border-secondary-800 modal-content">
              ...
              <p className="text-secondary-500 dark:text-secondary-400 m-0 mb-6 text-base leading-relaxed">
              ...
              <div className="mb-6 text-left">
                ...
                <div className="space-y-3">
                  <label
                    ...
                    className="flex items-center gap-3 p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:bg-secondary-50 dark:hover:bg-secondary-900"
                    style={{
                      borderColor:
                        paymentMethod === "cash"
              ...
              <div className="flex gap-3">
                ...
                <button
                  className="flex-1 py-3.5 border-none rounded-xl text-base font-bold cursor-pointer transition-colors duration-150 bg-primary-500 text-white shadow-md hover:bg-primary-600 flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
