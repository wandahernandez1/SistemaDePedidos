...
const Cart = ({
  ...
  return (
    <>
      ...
      {/* Cart Drawer */}
      <div
        className={`fixed top-0 right-0 w-full max-w-md h-screen bg-white dark:bg-secondary-900 shadow-2xl transition-transform duration-300 z-[999] flex flex-col ${
          isOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        {/* Header */}
        <div className="flex justify-between items-center px-6 py-5 border-b border-secondary-200 dark:border-secondary-800 bg-white dark:bg-secondary-900">
          <h2 className="text-2xl font-bold text-secondary-900 dark:text-secondary-50 m-0 tracking-tight">
            Tu Pedido
          </h2>
          <button
            className="bg-transparent border-none cursor-pointer text-secondary-500 dark:text-secondary-400 w-9 h-9 flex items-center justify-center rounded-lg transition-all duration-200 hover:bg-secondary-100 dark:hover:bg-secondary-800 hover:text-secondary-800 dark:hover:text-secondary-200"
            onClick={onClose}
        ...
        {cartItems.length === 0 ? (
          ...
          <>
            ...
            {/* Footer */}
            <div className="border-t border-secondary-200 dark:border-secondary-800 p-4 bg-white dark:bg-secondary-900 flex-shrink-0">
              {/* Delivery Type */}
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 border-2 rounded-lg cursor-pointer transition-all duration-200 ${
                      deliveryType === "pickup"
                        ? "border-primary-500 bg-primary-100 dark:bg-primary-500/20"
                        : "border-secondary-200 dark:border-secondary-600 bg-white dark:bg-secondary-800 hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-500/10"
                    }`}
                ...
                {deliveryType === "delivery" && (
                  <div className="mt-3 animate-fade-in">
                    <input
                      type="text"
                      className="w-full px-3 py-2.5 border-2 border-secondary-200 dark:border-secondary-700 rounded-lg text-sm transition-all duration-200 bg-transparent dark:text-secondary-100 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 placeholder:text-secondary-400"
              ...
              <div className="mb-4">
                ...
                <button
                  type="button"
                  className="w-full px-3 py-2.5 border-2 border-secondary-300 dark:border-secondary-600 rounded-lg text-sm font-semibold transition-all duration-200 bg-white dark:bg-secondary-800 text-secondary-800 dark:text-secondary-100 cursor-pointer flex items-center gap-2 hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/30"
                ...
                {showTimeSelector && (
                  ...
                  >
                    <div
                      className="bg-white dark:bg-secondary-900 rounded-t-3xl w-full max-w-md max-h-[70vh] overflow-hidden animate-slide-in"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <div className="flex items-center justify-between px-6 py-5 border-b border-secondary-200 dark:border-secondary-800 sticky top-0 bg-white dark:bg-secondary-900">
                          ...
                          <button
                            ...
                            className={`py-4 px-3 border-2 rounded-xl text-base font-semibold cursor-pointer transition-all duration-200 min-h-[52px] ${
                              deliveryTime === time
                                ...
                                : "bg-transparent border-secondary-200 dark:border-secondary-700 text-secondary-800 dark:text-secondary-100 hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/30"
                            }`}
                            onClick={() => {
              ...
              {/* Total */}
              <div className="flex justify-between items-center p-4 mb-4 bg-secondary-100 dark:bg-secondary-800 rounded-xl border border-secondary-200 dark:border-secondary-700">
              ...
              <div className="flex gap-3">
                <button
                  className="py-3.5 px-4 border-2 border-secondary-300 dark:border-secondary-600 rounded-xl text-sm font-bold cursor-pointer transition-all duration-300 flex items-center justify-center gap-2 bg-white dark:bg-secondary-800 text-secondary-700 dark:text-secondary-300 hover:bg-red-50 dark:hover:bg-red-900/30 hover:border-red-400 hover:text-red-600 dark:hover:text-red-400 hover:-translate-y-0.5 active:scale-[0.98]"
                  onClick={onClearCart}
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[1000] p-4 animate-fade-in">
          <div className="bg-white dark:bg-secondary-900 rounded-3xl p-8 max-w-md w-full text-center shadow-2xl animate-slide-in border border-secondary-200 dark:border-secondary-800">
            <div className="w-16 h-16 mx-auto mb-4 bg-primary-100 dark:bg-primary-500/20 rounded-full flex items-center justify-center">
            ...
            <div className="flex gap-3">
              <button
                className="flex-1 py-3.5 border-2 border-secondary-300 dark:border-secondary-600 rounded-xl text-base font-bold cursor-pointer transition-all duration-300 bg-white dark:bg-secondary-800 text-secondary-700 dark:text-secondary-300 hover:bg-secondary-100 dark:hover:bg-secondary-700 hover:border-secondary-400 dark:hover:border-secondary-500 hover:-translate-y-0.5 active:scale-[0.98]"
